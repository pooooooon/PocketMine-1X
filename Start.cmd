@echo off
REM Modified for PocketMine-SteadFast  (All I ask of you is, Please don't remove this line. Or you'll have to deal with a DMCA Take Down.)
...
) else if exist PocketMine-SteadFast.phar (
    set POCKETMINE_FILE=PocketMine-SteadFast.phar
) else (
    if exist src\pocketmine\PocketMine.php (
        set POCKETMINE_FILE=src\pocketmine\PocketMine.php
    ) else (
        msg * "ERROR: Couldn't find a PocketMine-SteadFast installation..."
        pause
        exit 1
    )
)
