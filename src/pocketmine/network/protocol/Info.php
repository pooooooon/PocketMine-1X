...
interface Info{
	...
	const MINECRAFT_VERSION = ["v1.XX"];
	const CURRENT_PROTOCOL = 92;
	const ACCEPTED_PROTOCOLS = [92, 100, 101, 102, 105, 106, 107, 110, 111, 112, 113, 134, 135, 136, 137, 140, 141, 150, 160, 200, 201, 220, 221, 222, 224, 223, 240, 250, 260, 261, 270, 271, 273, 274, 280, 281, 282, 290, 291, 310, 311, 312, 313, 330, 331, 332, 342, 340, 350, 351, 352, 353, 354, 360, 361, 370, 371, 385, 386, 387, 388, 389, 390, 392, 393, 394, 395, 396, 400, 406, 407, 408, 409, 410, 411, 419, 422];
	//92
	const PROTOCOL_92 = 92;
	const PROTOCOL_100 = 100;
	const PROTOCOL_101 = 101;
	const PROTOCOL_102 = 102;
	...
	const PROTOCOL_408 = 408; // 1.16.40
	const PROTOCOL_409 = 409;
	const PROTOCOL_410 = 410;
	const PROTOCOL_411 = 411;
	const PROTOCOL_412 = 412;
	const PROTOCOL_413 = 413;
